                ...
                <div class="col-lg-8 col-md-10 col-sm-12 join-form">
                    ...
                    <form action="update.board" method = "post" name = "regForm">
                        <div class="form-group">
                            <label>글번호</label>
                            <input type="text" class="form-control" readonly value = "${vo.bno }" name = "bno">
                        </div>
                        <div class="form-group">
                            <label>글쓴이</label>
                            <input type="text" class="form-control" readonly placeholder= "${vo.name }" >
                        </div>
                        <div class="form-group">
                            <label>제목</label>
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-default" onclick = "delete.board?bon=${vo.bno}">삭제</button>
                        </div>

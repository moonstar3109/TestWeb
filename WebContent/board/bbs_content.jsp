                ...
                <div class="col-lg-8 col-md-10 col-sm-12 join-form">
                    ...
                    <form action="modify.board" method = "post" name = "regForm"  >
                        <div class="form-group">
                            <label>등록일</label>
                            <input type="text" class="form-control" name = "regdate" readonly value = "${vo.regdate }">
                        </div>
                        <div class="form-group">
                            <label>글번호</label>
                            <input type="text" class="form-control" name = "bno"  readonly value = "${vo.bno}" >
                        </div>
                        <div class="form-group">
                            <label>글쓴이</label>
                            <input type="text" class="form-control" placeholder="자유" name = "name" readonly value = "${vo.name }">
                        </div>
                        <div class="form-group">
                            <label>제목</label>
                            <input type="text" class="form-control" placeholder="자유" name = "title"  readonly value = "${vo.title }">
                        </div>
                        <div class="form-group">
                            <label>내용</label>
